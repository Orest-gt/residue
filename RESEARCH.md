...
V4.1 was tested in a deeply sanitized, synthetic benchmark environment on consumer hardware. As we prepared Residue for multi-node, 64-core enterprise environments, we discovered that hardware physics broke our beautiful abstractions. V4.2 introduces "Reality-Synchronization".
